...
newspaper_root = Tk()
newspaper_root.title("RAJASTHAN PATRIKA")
date_label = Label(text = "5 jan 2022",fg = "red")
date_label.pack(side = TOP,anchor="nw", fill = Y,padx = 30,pady = 30)
newspaper_root.geometry = ("444x345")
# image = Image.open("1.jpg")
# photo = Image.PhotoImage(image)
# varun_label = Label(image=photo)
# # varun_label.pack(side=RIGHT)
sports_label_heading = Label(text = "SPORTS NEWS", fg = "green")
sports_label_heading.pack(anchor="sw",padx=32,pady=20)
newspaper_root.geometry = ("444x345")
# image = Image.open("2.jpg")
# photo = Image.PhotoImage(image)
# sports_label = Label(image=photo)
# sports_label.pack(side=BOTTOM, anchor="se")

newspaper_root.mainloop()
